...
const Footer = () => {
    return (
        <>
            <div className='lg:h-[500px] lg:flex xl:justify-around  lg:items-center lg:justify-evenly md:flex md:items-center md:flex-wrap sm:flex sm:flex-wrap  md:h-[800px] md:justify-evenly sm:h-[900px] lg:gap-x-0 md:gap-x-10 sm:gap-x-4 lg:mx-0 md:mx-10 sm:justify-evenly ' >
                ...
                <div className='flex flex-col space-y-5'>
                    <div className='flex gap-x-2'>
                        <img src={facebook} alt="" className='md:h-[40px] md:w-[40px] sm:h-[20px] sm:w-[20px]' />
                        <img src={linkedin} alt="" className='md:h-[40px] md:w-[40px] sm:h-[20px] sm:w-[20px]' />
                        <img src={twitter} alt="" className=' md:h-[40px] md:w-[40px] sm:h-[20px] sm:w-[20px]' />
                        <img src={insta} alt="" className='   md:h-[40px] md:w-[40px] sm:h-[20px] sm:w-[20px]' />
                    </div>
                    <div>
